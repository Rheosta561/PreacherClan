        ...
        setMessages(
          response.data.map((msg) => {
            ...
            const base = {
              ...
              profileImage:
                msg.sender._id === userId ? profile.profileImage : msg.sender.image,
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          timestamp: new Date(),
          profileImage: newMsg.sender.image,
          replyTo: replyingTo,
        },
      ]);
      setInput('');
    ...
    <div className="flex flex-col h-screen bg-zinc-950 pt-20 text-white">
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((msg) => {
          ...
          const showLabel = currentLabel && currentLabel !== lastLabel;
          if (showLabel) lastLabel = currentLabel;
          ...
          return (
            <div key={msg.id}>
              {showLabel && (
                <div className="text-center text-xs text-zinc-400 my-2">{currentLabel}</div>
              )}
              <div
